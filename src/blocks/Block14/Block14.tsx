  ...
  return (
    <div className="bg-beige-400 py-16 xl:py-20">
      <div className="flex flex-col gap-10 items-center  justify-between w-[90%] md:flex-row xl:w-[85%] 2xl:w-[75%] mx-auto">
        <div className="bg-blau-500 relative w-[90%] h-[380px] xl:h-[550px] rounded-t-[50%]  md:w-[40%]">
          <Image
            src={hostEvent}
            alt="host Event"
          ...
          <div className="flex items-center mt-10">
            ...
            <div className="border border-[#89815578] p-[2px] rounded-[2px]">
              <Button
                ...
                className="group bg-transparent border border-beige-500 hover:bg-beige-500 text-sm cursor-pointer rounded-[2px] px-6 py-5 text-beige-500 hover:text-white  flex items-center justify-center transition-all duration-300"
              >
