...
const Slider = () => {
  ...
  return (
    <section className="bg-black py-[100px] pb-[50px] xl:pb-[50px] xl:pt-[100px] md:pt-[50px] w-full h-full relative overflow-hidden">
      <h2
        className="text-white text-[18px] font-thankslabs mb-[30px] text-center sm:text-[24px] md:text-[30px] xl:mb-[0px]  xl:text-[32px]"
      ...
      {/* Small screens */}
      <div
        className="relative xl:hidden  h-[800px]  md:h-[900px]"
        data-aos="custom-fade-in"
        data-aos-delay="400"
      >
        <div className="">
      ...
      {/* XL Screen */}
      <div
        className="hidden xl:flex flex-col items-center w-screen overflow-hidden"
        data-aos="custom-fade-in"
        data-aos-delay="300"
      >
                ...
                <div className="flex flex-col justify-center gap-4 p-[40px] w-1/4 bg-black text-white">
                  ...
                  <div className="flex mt-6 space-x-2 justify-center">
                    {lint.map((_, dotIdx) => (
                      <span
                        key={dotIdx}
                        className={`w-[9px] h-[9px] rounded-full ${dotIdx === current ? 'bg-[white]' : 'bg-[#3a3a3a]'}`}
                      />
                    ))}
                  </div>
                </div>
