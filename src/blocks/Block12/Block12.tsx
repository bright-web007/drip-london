...
const Block12 = () => {
  return (
    <div className="flex items-center justify-between mx-auto w-[90%] xl:w-[75%] 2xl:w-[70%] py-16 xl:py-20">
      <div className="bg-beige-400 relative flex items-center h-[450px] w-[58%] overflow-hidden">
        <Image
          src={eggs}
          alt="deals"
          width={400}
      ...
      <div className="flex flex-col items-center justify-between h-[450px] w-[38%]">
