        ...
        >
          <div className="lg:w-[720px] xl:w-[383px] mb-[120px] xl:mb-[160px]">
            ...
            <h2
              data-aos="custom-fade-in"
              data-aos-delay="300"
              className="text-[18px] text-white font-thankslabs not-italic leading-[35px] font-bold mb-[30px] text-center sm:text-[21px] md:text-[24px] md:mb-[24px] lg:text-[28px] lg:mb-[50px] xl:text-[18px] xl:mb-[25px]"
            >
              {men.title}
            </h2>
            <div data-aos="custom-fade-in" data-aos-delay="300">
              <div className="border-1 border-[#232323] rounded-[4px]">
                ...
                <div
                  data-aos="custom-fade-in"
                  data-aos-delay="500"
                  className="w-full mb-[18px] md:mb-[56px] xl:mb-0"
                >
                  {men.img && (
                    <div
                ...
                <div
                  data-aos="custom-fade-in"
                  data-aos-delay="500"
                  className="py-[24px] px-[30px] xl:flex md:pt-[10px] md:pb-[25px] lg:pt-[2px] xl:flex-col xl:justify-center"
                >
