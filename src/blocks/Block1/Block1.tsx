...
const Block1 = () => {
  ...
  return (
    <div className="flex flex-col mt-[-72px] font-monserrat bg-gray-500 h-[100vh] xl:h-[105vh] relative">
      <LayoutHeader />
      <div className=" absolute bg-red-200 inset-0 z-15 flex flex-col items-center justify-center">
      ...
      <div className=" absolute bg-amber-200 z-15 bottom-[5%] flex items-end justify-between w-full px-4 md:px-12">
