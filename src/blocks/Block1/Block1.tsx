...
const Block1 = () => {
  return (
    <div className="flex flex-col mt-[-72px] font-monserrat bg-gray-700 h-[100vh] xl:h-[140vh]">
      <div className=" flex flex-col items-center  mt-80 h-full">
        <h1 className=" text-[24px] md:text-[32px] xl:text-[50px] font-bold w-[60%] text-center text-white">
          {' '}
          Welcome to DRIP LONDON
        </h1>
        <p className="text-[20px] text-white leading-6 font-normal w-[70%] md:w-[55%] xl:w-[30%] text-center mt-8 mb-6">
      ...
      <div className="flex items-end justify-between px-12 pb-8">
        <Image src={followUs} alt="Follow us" width={20} height={310} />

        <div className="flex flex-col items-center gap-x-2">
          <Icon icon="devicon:google" className="text-white w-12 h-12 cursor-pointer" />
          <div className="flex items-center">
