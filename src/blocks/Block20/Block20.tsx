...
const Block20 = () => {
  return (
    <section
      ...
      id="next"
    >
      <h2 className="text-center text-[#D5D5D5] text-[18px] flex flex-col mt-[33px] mb-[33px] leading-[28px] font-normal sm:text-[24px] lg:text-[32px] sm:leading-[37px] md:mb-[56px] xl:leading-[44px]  xl:md:mb-[46px]">
        <span>Elevated</span>
        <span>Dining Experiences</span>
      </h2>
      <div className="flex gap-[33px] xl:grid-cols-2  md:gap-[45px] justify-center z-10">
