...
const Block2 = () => {
  return (
    <section
      id="next-section"
      className="bg-[#000000] py-12 px-6 w-full  h-full md:py-[25px] md:px-[40px] lg:py-[70px] xl:py-[86px] xl:px-[100px]"
    >
        ...
        <div className="flex gap-[12px] w-[300px] px-2 md:w-[464px]">
          {dishes.map((dish, index) => (
            ...
            >
              ...
              {/* Content */}
              <div className="flex flex-col text-center px-[50px] mb-[30px] gap-[30px] sm:px-[90px] md:mb-[50.5px] md:px-[40px] md:gap-[8px]">
                <h3 className="text-[14px] font-thankslabs  sm:text-[16px] md:text-[17px]">
                  {dish.title}
                </h3>
