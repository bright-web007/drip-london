...
const Block2 = () => {
  return (
    <div className="flex flex-col items-center bg-white py-20">
      <div className="flex flex-col items-center mx-auto w-[80%] md:w-[60%] xl:w-[40%]">
        <Image src={forkKnife} alt="Drip London Logo" width={48} height={60} />
        <h1 className="text-sm xl:text-xl font-semibold leading-8 xl:leading-10 text-center text-beige-500">
      ...
      <div className="flex flex-col md:flex-row items-center justify-center w-[90%] mx-auto gap-y-4 md:gap-x-4 mt-12">
        {[
          ...
          >
            <div className="relative w-full h-full overflow-hidden">
              ...
              <div
                className="absolute left-1/2 transform -translate-x-1/2 text-white text-sm font-semibold z-10 transition-all duration-500 ease-in-out
                        bottom-8 group-hover:bottom-1/2 group-hover:translate-y-1/2 capitalize text-center"
              >
                {item.alt}
              </div>
            </div>
