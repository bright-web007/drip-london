  ...
  return (
    <><div className="bg-[#0D0D0D] pt-[40px] pr-[24px] pl-[24px] pb-[24px]  xl:flex xl:gap-[24px]  xl:pr-[100px] xl:pl-[100px]  xl:pt-[60px]  xl:pb-[24px]">
      <div className="flex flex-col text-[#EBEBEB] mb-[24px]  xl:w-[full]">
        <h1 className="text-[14.626px] font-thankslabs mb-[16px] text-[#898155]  sm:text-[19px]  md:text-[27.049px]  md:mb-[44px]">DRIP LONDON</h1>
        ...
        <div className="flex flex-col text-[12px]  font-Montserrat sm:text-[13px]   md:text-[14px]  md:flex-row  md:items-center">
          <div> <Image src={location} alt="Icon" className="w-[39px] h-[39px] mr-[14px] object-contain  hidden  md:block" /></div>
        ...
        <div className="flex gap-[14px] mt-[11px]  md:mt-[24px]  md:flex-col">
          ...
          <div className="md:flex md:items-center">
            ...
            <div><p className="hidden text-[14px] md:block leading-[18px] ml-[14px]   md:text-[14px]  xl:text-[16px]">+44 7923628705</p></div>
          </div>
          ...
          <div className="md:flex md:items-center">
            ...
            <div><a href="mailto:Reservations@drip.london" className="hidden text-[14px] md:block leading-[18px] ml-[14px]   md:text-[14px]  xl:text-[16px]">Reservations@drip.london</a></div>
          </div>
          ...
          <div className="md:flex md:items-center">
            ...
            <div><p className="hidden md:block text-[14px] leading-[18px] ml-[14px]   md:text-[14px]  xl:text-[16px]">+44 7923628705</p></div>
          </div>
