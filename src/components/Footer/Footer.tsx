    ...
    <div className="bg-[#0D0D0D]">
      <div className="bg-[#0D0D0D] pt-[40px] pr-[28px] pl-[28px] sm:pr-[40px] sm:pl-[40px] pb-[24px] xl:flex xl:gap-[70px] xl:pr-[100px] xl:pl-[100px] xl:pt-[60px] xl:pb-[24px]">
        <div className="flex flex-col text-[#EBEBEB] mb-[24px] xl:w-[full]">
          ...
          <p className="text-[14px] text-[#cfcfcf] font-Montserrat font-light mb-[24px] sm:leading-[29px] sm:text-[21px] md:text-[24px] md:leading-[30px] md:mb-[38px] xl:text-[20px]  xl:w-[490px]">
          ...
          <div className="flex flex-col mb-[-8px] text-[12px] font-Montserrat sm:text-[13px] md:text-[14px] md:flex-row md:items-center">
            ...
            <div className="md:flex text-[#cfcfcf] text-[14px] md:text-[24px] font-light sm:text-[21px] xl:text-[20px]">
          ...
          <div className="flex gap-[14px] mt-[30px] md:mt-[24px] md:flex-col  sm:mt-[28px]">
            <div className="md:flex md:items-center cursor-pointer">
              ...
              <div>
                <a href="tel:+44 7923628705">
                  <p className="hidden text-[14px] font-light md:block leading-[18px] text-[#cfcfcf] sm:text-[21px] ml-[14px] md:text-[24px]  xl:text-[20px]">
                    +44 7923628705
                  </p>
                </a>
              </div>
            ...
            <div className="md:flex md:items-center pointer-cursor">
              ...
              <div>
                <a
                  ...
                  className="hidden text-[14px] font-light md:block leading-[18px] ml-[14px] md:text-[24px] sm:text-[21px] text-[#cfcfcf] xl:text-[20px]"
                >
            ...
            <div className="md:flex md:items-center cursor-pointer">
              ...
              <div>
                <p className="hidden md:block text-[14px] font-light leading-[18px] ml-[14px] md:text-[24px] sm:text-[21px] text-[#cfcfcf] xl:text-[20px]">
                  +44 7923628705
                </p>
              </div>
            </div>
        ...
        <div className="mt-[24px] flex gap-[24px] sm:mt-[50px] md:mb-[24px] xl:w-full xl:mt-[75px] xl:gap-[0px] ">
          <div className="flex flex-col w-full gap-[20px] sm:gap-[30px]">
            <p className="text-[12px] font-thankslabs text-[#898155] leading-[12px] not-italic font-[500px]  sm:text-[21px] md:text-[25px] md:leading-[26px]  md:pb-[18px]  xl:text-[20px]">
              QUICK LINKS
            </p>
            <div className="flex flex-col gap-[20px] sm:gap-[32px] md:gap-[38px]">
              {navLinker.map(item => (
                <React.Fragment key={item.name}>
                  <a
                    href={item.link}
                    className="text-[14px]  leading-[12px] font-light cursor-pointer text-[#cfcfcf] whitespace-nowrap md:text-[24px] sm:text-[21px] xl:text-[20px]"
                  >
                    {item.name}
                  </a>
                </React.Fragment>
          ...
          <div className="flex flex-col gap-[20px] sm:gap-[30px] w-full  ">
            <p className="text-[12px] font-thankslabs text-[#898155] leading-[12px] not-italic font-[500px] md:text-[25px] md:leading-[26px] sm:text-[21px]  md:pb-[18px]  xl:text-[20px]">
              LEGAL
            </p>

            <div className="text-[14px] text-[#cfcfcf] gap-[20px] leading-[12px] flex flex-col sm:gap-[32px] md:text-[24px] font-light sm:text-[21px]  md:gap-[38px] xl:text-[20px]">
